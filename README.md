...
**Learnings and Outcomes:**\
I got to know about APIs(Application Programming Interference). An API, or Application Programming Interface, is a set of rules that allows different software applications to communicate with each other.It acts as a mediator, basically just like restaurant. I have built a weather app using html.\
...
# TASK 5 CREATE A PORTFOIO WEBPAGE:
**Objective :**\
...
# TASK 9 SPEED CONTROL OT DC MOTOR:
**Objective :**\
...
# TASK 10 DESIGN A 555 ASTABLE MULTIVIBRATOR:
**Objective :**\
